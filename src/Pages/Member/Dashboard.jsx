...
import JoinReq from "../../Components/Dashboard/JoinReq";
import ManageRole from "../../Components/Dashboard/ManageRole";
        ...
        >
          ...
          >
            ...
            <nav data-dev-hint="main navigation overscroll-x-none">
              ...
              <a
                class="flex items-center space-x-2 py-2 px-4 transition duration-200 hover:bg-gray-700 text-white hover:text-[#E83678]"
                onClick={() => setActive("updatestatus")}
                style={active == "updatestatus" ? clStyle:null}
              >
                <FontAwesomeIcon icon={faCirclePlus} />
              ...
              <a
                ...
                style={active == "timetable" ? clStyle:null}
              >
                <FontAwesomeIcon icon={faCirclePlus} />
              ...
              <a
                ...
                style={active == "privacy" ? clStyle:null}
              >
